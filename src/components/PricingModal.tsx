...
export default function PricingModal({ isOpen, onClose, planName, planPrice }: PricingModalProps) {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative z-[105] w-full max-w-[480px]">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10">
          <h2 className="text-lg sm:text-xl font-extrabold text-black tracking-wide text-center mb-3 uppercase">
            {planName}
          </h2>

          <p className="text-3xl font-bold text-[#58DDB0] text-center mb-2">
            {planPrice}
          </p>

          <p className="text-sm text-[#1a1a1a] text-center leading-relaxed mb-4">
            Build a Successful E-Commerce Business on Shopify.
          </p>
